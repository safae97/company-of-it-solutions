...
<form action="logout.php" method="post">
  ...
  <div class="bs-example">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="page-header clearfix">
                        <h2 class="pull-left">Formations</h2>
                    </div>
                    <?php
                    include_once 'dbconnection.php';
                    $result = mysqli_query($conn, "SELECT formation_id, formation_nom, budget_id FROM formation");
                    ...
                    ?>
                    <tr>
                        <td><?php echo $row["formation_id"]; ?></td>
    ...
    <h3 class="pull-left">Attribuer un Budget a une Formation</h3>
<br>    <form action="addbudgettoformation.php" method="post" >
    <div class="form-group">
  <label for="formationname">Nom de Formation :</label>
        <input type="text" id="formationname" name="formationname" required>
  </div>
      <div class="form-group">
      ...
      <div class="button-container">
        <button type="submit" class="btn  btn-lg  " data-bs-toggle="hover" style="background-color: #007bff;color: antiquewhite; ">Enregistrer Budget</button>
      </div>
    </form><br>    
